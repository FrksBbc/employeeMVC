...
<div class="container mt-5 d-flex justify-content-center">
    <div class="col-sm-6">
        <form action="index.php?controller=employeeCategory&action=update&id=<?php echo $employeeCategory->id;?>"
            method="POST">

            <div class="form-group">
                <label for="name">Név* - egyedinek kell lennie</label>
                <input type="text" class="form-control" name="employeeCategory[name]" id="name"
                    value='<?php echo $employeeCategory->name; ?>' required>
            </div>
