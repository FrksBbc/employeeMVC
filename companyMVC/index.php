    ...
    case 'employee':
        ...
        switch ($actionName) {
            ...
            case 'listProgrammers':
                ...
                break;
            case 'listActiveWorker':
                $content = $controller -> listActiveWorkers();
                break;
            case 'getAvgSalaryOfDesigners':
                $content = $controller -> getAvgSalaryOfDesigners();
                break;
            case 'filterEmployees':
                $content = $controller -> filterEmployees();
                break;
        }
        break;
